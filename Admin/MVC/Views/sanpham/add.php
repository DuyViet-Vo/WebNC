<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
  ...
  <form action="?mod=sanpham&act=store" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="" placeholder="" name="MSP">
    </div>
    <div class="form-group">
      <label for="">Hãng Nhập Khẩu</label>
      <input type="text" class="form-control" id="" placeholder="" name="HangNK">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="" placeholder="" name="TrongLuongSP">
    </div>
    <div class="form-group">
      <label for="">Trọng Lượng Tối Đa</label>
      <input type="text" class="form-control" id="" placeholder="" name="TrongLuongMax">
    </div>
    <div class="form-group">
      <label for="">Bảo Hành</label>
      <input type="text" class="form-control" id="" placeholder="" name="BaoHanh">
    </div>
    <div class="form-group">
