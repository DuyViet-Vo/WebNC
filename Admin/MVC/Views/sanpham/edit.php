...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=sanpham&act=update" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="" name="MSP" value="<?=$data['MSP']?>">
        </div>
        <div class="form-group">
            <label for="">Hãng Nhập Khẩu</label>
            <input type="text" class="form-control" id="" placeholder="" name="HangNK" value="<?=$data['HangNK']?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="">Trọng Lượng Sản Phẩm</label>
            <input type="text" class="form-control" id="" placeholder="" name="TrongLuongSP" value="<?=$data['TrongLuongSP']?>">
        </div>
        <div class="form-group">
            <label for="">Trọng Lượng Tối Đa</label>
            <input type="text" class="form-control" id="" placeholder="" name="TrongLuongMax" value="<?=$data['TrongLuongMax']?>">
        </div>
        <div class="form-group">
            <label for="">Bảo Hành</label>
            <input type="text" class="form-control" id="" placeholder="" name="BaoHanh" value="<?=$data['BaoHanh']?>">
        </div>
        <div class="form-group">
