    ...
    <div class="container">
        <div class="row">
            <div class="single-list-view">
                <div class="col-xs-12 col-sm-5 col-md-4 box-image-detail">
                            ...
                            <div class="tb">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div><?= $data['TrongLuongSP'] ?></div>
                                    </li>
                                    <li>
                                        <span>Trọng Lượng Tối Đa</span>
                                        <div><?= $data['TrongLuongMax'] ?></div>
                                    </li>
                                </ul>
                            </div>
                            <?php }?>
