...
<div class="tab-products single-products section-padding extra-padding-top">
    <div class="container contain-tab-product">
        <div class="row">
            <div class="col-xs-12 px-0">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">Máy Tập Thể Dục <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular">Dụng Cụ Tập Gym <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best">Dụng Cụ Tập Yoga</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane  fade in active" id="arrival">
                <div class="wrapper">
                    <ul class="load-list load-list-two">
                        ...
                        <li>
                            <div class="row text-center" style="margin-bottom: 20px;"><b><a href="?act=shop">Vào cửa hàng để xem nhiều hơn!</a></b></div>
                        </li>
                    </ul>
...
<section class="collection-area collection-area2 section-padding">
    <div class="container contain-collection-area">
        <div class="row">
            <div class="col-xs-12 px-0">
                <div class="section-title text-center">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="collect-img banner margin single-colect">
                    <a href="?act=detail&id=<?= $data_random['0']['MaSP'] ?>"><img src="public/<?= $data_random['0']['HinhAnh2'] ?>" alt="" /></a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="single-colect banner collect-one">
...
<section class="single-products  products-two section-padding extra-padding-bottom">
    <div class="container contain-single-product">
        <div class="row">
            <div class="col-xs-12 px-0">
                <div class="section-title text-center">
